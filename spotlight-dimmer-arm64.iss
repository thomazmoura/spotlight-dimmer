; Inno Setup Script for Spotlight Dimmer (ARM64)
...
OutputDir=dist
OutputBaseFilename=spotlight-dimmer-installer-arm64
...
[Files]
; Main executables from ARM64 publish directory
Source: "publish\arm64\SpotlightDimmer.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "publish\arm64\SpotlightDimmer.Config.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "publish\arm64\SpotlightDimmer.PaneReport.exe"; DestDir: "{app}"; Flags: ignoreversion
