...
/// <summary>
/// Standard renderer using SetWindowPos + SetLayeredWindowAttributes approach.
...
/// Lightweight memory footprint - no bitmap allocation required.
/// </summary>
internal class LayeredWindowRenderer : IOverlayRenderer
{
